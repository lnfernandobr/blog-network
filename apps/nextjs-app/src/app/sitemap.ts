...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticUrls: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/calculadora`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${SITE_URL}/checklist`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${SITE_URL}/produtos`, lastModified: now, changeFrequency: 'weekly', priority: 0.6 },
