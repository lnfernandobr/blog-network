 ...
 * que os componentes do site (StripeImage, tags coloridas) já esperam.
 *
 * O design original tem 4 categorias com cor fixa (rose/sage/plum/deep). Como
 * a API serve categorias dinâmicas, derivamos `catTone`/`tone` por hash
 * determinístico do slug — assim a mesma categoria sempre tem a mesma cor.
 */
